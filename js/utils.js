...
(function(){
	...
	*/
	...
	window.anesta_document_set_location = function(curLoc){
		try {
	...
	/* Debug functions
	---------------------------------------------------------------- */
	window.anesta_debug_object = function(obj) {
		...
		if (obj !== null && (typeof(obj) == 'object' || typeof(obj) == 'array')) {
			for (var prop in obj) {
				...
				if (level < recursive && (typeof(obj[prop]) == 'object' || typeof(obj[prop]) == 'array') && obj[prop] != obj) {
					dispStr += addStr + prop + '=' + anesta_debug_object( obj[prop], recursive, showMethods, level + 1 );
				} else {
					try {
						curStr = "" + obj[prop];
					} catch (e) {
	...
	window.anesta_debug_log = function(s, clr) {
		if (ANESTA_STORAGE['user_logged_in']) {
	...
	window.dco === undefined && (window.dco = function(s,r) { console.log( anesta_debug_object( s,r ) ); });
	window.dcs === undefined && (window.dcs = function() { console.trace(); });
	window.dal === undefined && (window.dal = function(s) { if (ANESTA_STORAGE['user_logged_in']) {
			alert( s );
	} });
	window.dao === undefined && (window.dao = function(s,r) { if (ANESTA_STORAGE['user_logged_in']) {
			alert( anesta_debug_object( s,r ) );
	} });
	window.ddl === undefined && (window.ddl = function(s,c) { anesta_debug_log( s,c ); });
	window.ddo === undefined && (window.ddo = function(s,r,c) { anesta_debug_log( anesta_debug_object( s,r ),c ); });
