...
if ( ! function_exists( 'anesta_trx_addons_theme_setup9' ) ) {
	...
	function anesta_trx_addons_theme_setup9() {
		if ( anesta_exists_trx_addons() ) {
			...
			add_filter( 'trx_addons_filter_no_image', 'anesta_trx_addons_no_image' );
...
if ( ! function_exists( 'anesta_trx_addons_no_image' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_no_image', 'anesta_trx_addons_no_image');
	function anesta_trx_addons_no_image( $no_image = '' ) {
		return anesta_get_no_image( $no_image );
	}
}
...
if ( ! function_exists( 'anesta_trx_addons_get_list_icons_classes' ) ) {
	...
	function anesta_trx_addons_get_list_icons_classes( $list, $prepend_inherit ) {
		return anesta_get_list_icons_classes( $prepend_inherit );
	}
}
...
if ( anesta_exists_trx_addons() ) {
	require_once anesta_get_file_dir( 'plugins/trx_addons/trx_addons-style.php' );
}
