...
class OCDI_Demo_Importer {
	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import Pwe Home Multipage', 'pwe' ),
				'page'  => __( 'Home Multipage', 'pwe' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/1.jpg',
				'preview_link' => 'https://shtheme.org/demosd/pwe/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import Pwe Home Video', 'pwe' ),
				'page'  => __( 'Home Video', 'pwe' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/3.jpg',
				'preview_link' => 'https://shtheme.org/demosd/pwe/?page_id=103',
			),
			'medinet_home_3' => array(
				'title' => __( 'Import Pwe Home Kenburns', 'pwe' ),
				'page'  => __( 'Home Kenburns', 'pwe' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/1.jpg',
				'preview_link' => 'https://shtheme.org/demosd/pwe/?page_id=97',
			),
			'medinet_home_4' => array(
				'title' => __( 'Import Pwe Home One Page', 'pwe' ),
				'page'  => __( 'Home One Page', 'pwe' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/2.jpg',
				'preview_link' => 'https://shtheme.org/demosd/pwe/?page_id=105',
			),
			'medinet_home_5' => array(
				'title' => __( 'Import Pwe Home One Page Video', 'pwe' ),
				'page'  => __( 'Home One Page Video', 'pwe' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/4.jpg',
				'preview_link' => 'https://shtheme.org/demosd/pwe/?page_id=110',
			),
			'medinet_home_6' => array(
				'title' => __( 'Import Pwe Home One Page Kenburn', 'pwe' ),
				'page'  => __( 'Home One Page Kenburn', 'pwe' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/2.png',
				'preview_link' => 'https://shtheme.org/demosd/pwe/?page_id=107',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'pwe' ),
			);
		}
	...
	private function assign_menu_to_location() {
		...
		$one_menu = get_term_by( 'name', 'One Page Menu', 'one-page' );

	    set_theme_mod( 'nav_menu_locations', array(
	            'primary' => $main_menu->term_id,   
	            'one-page' => $one_menu->term_id,  
	        )
	    );
	}
