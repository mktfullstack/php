...
if ( ! function_exists( 'anesta_storage_get' ) ) {
	/**
	 ...
	 */
	function anesta_storage_get( $var_name, $default = '' ) {
		global $ANESTA_STORAGE;
		return isset( $ANESTA_STORAGE[ $var_name ] ) ? $ANESTA_STORAGE[ $var_name ] : $default;
	}
}

if ( ! function_exists( 'anesta_storage_set' ) ) {
	/**
	 ...
	 */
	function anesta_storage_set( $var_name, $value ) {
		global $ANESTA_STORAGE;
		$ANESTA_STORAGE[ $var_name ] = $value;
	}
}

if ( ! function_exists( 'anesta_storage_empty' ) ) {
	/**
	 ...
	 */
	function anesta_storage_empty( $var_name, $key = '', $key2 = '' ) {
		global $ANESTA_STORAGE;
		if ( ! empty( $key ) && ! empty( $key2 ) ) {
			return empty( $ANESTA_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( ! empty( $key ) ) {
			return empty( $ANESTA_STORAGE[ $var_name ][ $key ] );
		} else {
			return empty( $ANESTA_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'anesta_storage_isset' ) ) {
	/**
	 ...
	 */
	function anesta_storage_isset( $var_name, $key = '', $key2 = '' ) {
		global $ANESTA_STORAGE;
		if ( ! empty( $key ) && ! empty( $key2 ) ) {
			return isset( $ANESTA_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( ! empty( $key ) ) {
			return isset( $ANESTA_STORAGE[ $var_name ][ $key ] );
		} else {
			return isset( $ANESTA_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'anesta_storage_unset' ) ) {
	/**
	 ...
	 */
	function anesta_storage_unset( $var_name, $key = '', $key2 = '' ) {
		global $ANESTA_STORAGE;
		if ( ! empty( $key ) && ! empty( $key2 ) ) {
			unset( $ANESTA_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( ! empty( $key ) ) {
			unset( $ANESTA_STORAGE[ $var_name ][ $key ] );
		} else {
			unset( $ANESTA_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'anesta_storage_inc' ) ) {
	/**
	 ...
	 */
	function anesta_storage_inc( $var_name, $value = 1 ) {
		global $ANESTA_STORAGE;
		if ( empty( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = 0;
		}
		$ANESTA_STORAGE[ $var_name ] += $value;
	}
}

if ( ! function_exists( 'anesta_storage_concat' ) ) {
	/**
	 ...
	 */
	function anesta_storage_concat( $var_name, $value ) {
		global $ANESTA_STORAGE;
		if ( empty( $ANESTA_STORAGE[ $var_name ] ) ) {
...
if ( ! function_exists( 'anesta_storage_get_array' ) ) {
	/**
	 ...
	 */
	function anesta_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $ANESTA_STORAGE;
		if ( empty( $key2 ) ) {
			return ! empty( $var_name ) && ! empty( $key ) && isset( $ANESTA_STORAGE[ $var_name ][ $key ] ) ? $ANESTA_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && ! empty( $key ) && isset( $ANESTA_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $ANESTA_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}

if ( ! function_exists( 'anesta_storage_set_array' ) ) {
	/**
	 ...
	 */
	function anesta_storage_set_array( $var_name, $key, $value ) {
		global $ANESTA_STORAGE;
		if ( ! isset( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$ANESTA_STORAGE[ $var_name ][] = $value;
		} else {
...
if ( ! function_exists( 'anesta_storage_set_array2' ) ) {
	/**
	 ...
	 * @param mixed  $value     A new value for the specified element of the array.
	 */
	function anesta_storage_set_array2( $var_name, $key, $key2, $value ) {
		global $ANESTA_STORAGE;
		if ( ! isset( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = array();
		}
		if ( ! isset( $ANESTA_STORAGE[ $var_name ][ $key ] ) ) {
			$ANESTA_STORAGE[ $var_name ][ $key ] = array();
		}
		if ( '' === $key2 ) {
			$ANESTA_STORAGE[ $var_name ][ $key ][] = $value;
		} else {
			$ANESTA_STORAGE[ $var_name ][ $key ][ $key2 ] = $value;
		}
	}
}

if ( ! function_exists( 'anesta_storage_merge_array' ) ) {
	/**
	 ...
	 */
	function anesta_storage_merge_array( $var_name, $key, $value ) {
		global $ANESTA_STORAGE;
		if ( ! isset( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$ANESTA_STORAGE[ $var_name ] = array_merge( $ANESTA_STORAGE[ $var_name ], $value );
		} else {
			$ANESTA_STORAGE[ $var_name ][ $key ] = array_merge( $ANESTA_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'anesta_storage_set_array_after' ) ) {
	/**
	 ...
	 */
	function anesta_storage_set_array_after( $var_name, $after, $key, $value = '' ) {
		global $ANESTA_STORAGE;
		if ( ! isset( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			anesta_array_insert_after( $ANESTA_STORAGE[ $var_name ], $after, $key );
		} else {
			anesta_array_insert_after( $ANESTA_STORAGE[ $var_name ], $after, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'anesta_storage_set_array_before' ) ) {
	/**
	 * Insert new elements to the array in the global theme storage
	 ...
	 * @param mixed        $value     A new value to insert (if the argument $key is a string).
	 */
	function anesta_storage_set_array_before( $var_name, $before, $key, $value = '' ) {
		global $ANESTA_STORAGE;
		if ( ! isset( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			anesta_array_insert_before( $ANESTA_STORAGE[ $var_name ], $before, $key );
		} else {
			anesta_array_insert_before( $ANESTA_STORAGE[ $var_name ], $before, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'anesta_storage_push_array' ) ) {
	/**
	 ...
	 */
	function anesta_storage_push_array( $var_name, $key, $value ) {
		global $ANESTA_STORAGE;
		if ( ! isset( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			array_push( $ANESTA_STORAGE[ $var_name ], $value );
		} else {
			if ( ! isset( $ANESTA_STORAGE[ $var_name ][ $key ] ) ) {
				$ANESTA_STORAGE[ $var_name ][ $key ] = array();
			}
			array_push( $ANESTA_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'anesta_storage_pop_array' ) ) {
	/**
	 ...
	 */
	function anesta_storage_pop_array( $var_name, $key = '', $defa = '' ) {
		global $ANESTA_STORAGE;
		$rez = $defa;
		if ( '' === $key ) {
			if ( isset( $ANESTA_STORAGE[ $var_name ] ) && is_array( $ANESTA_STORAGE[ $var_name ] ) && count( $ANESTA_STORAGE[ $var_name ] ) > 0 ) {
				$rez = array_pop( $ANESTA_STORAGE[ $var_name ] );
			}
		} else {
			if ( isset( $ANESTA_STORAGE[ $var_name ][ $key ] ) && is_array( $ANESTA_STORAGE[ $var_name ][ $key ] ) && count( $ANESTA_STORAGE[ $var_name ][ $key ] ) > 0 ) {
				$rez = array_pop( $ANESTA_STORAGE[ $var_name ][ $key ] );
			}
		}
		return $rez;
	}
...
if ( ! function_exists( 'anesta_storage_inc_array' ) ) {
	/**
	 ...
	 * @param int          $value     Optional. A value for increment. Default is 1. Specify -1 to decrement or any legal number value.
	 */
	function anesta_storage_inc_array( $var_name, $key, $value = 1 ) {
		global $ANESTA_STORAGE;
		if ( ! isset( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = array();
		}
		if ( empty( $ANESTA_STORAGE[ $var_name ][ $key ] ) ) {
			$ANESTA_STORAGE[ $var_name ][ $key ] = 0;
		}
		$ANESTA_STORAGE[ $var_name ][ $key ] += $value;
	}
}

if ( ! function_exists( 'anesta_storage_concat_array' ) ) {
	/**
	 ...
	 * @param int          $value     A value to concatenate.
	 */
	function anesta_storage_concat_array( $var_name, $key, $value ) {
		global $ANESTA_STORAGE;
		if ( ! isset( $ANESTA_STORAGE[ $var_name ] ) ) {
			$ANESTA_STORAGE[ $var_name ] = array();
		}
		if ( empty( $ANESTA_STORAGE[ $var_name ][ $key ] ) ) {
			$ANESTA_STORAGE[ $var_name ][ $key ] = '';
		}
		$ANESTA_STORAGE[ $var_name ][ $key ] .= $value;
	}
}

if ( ! function_exists( 'anesta_storage_call_obj_method' ) ) {
	/**
	 ...
	 */
	function anesta_storage_call_obj_method( $var_name, $method, $param = null ) {
		global $ANESTA_STORAGE;
		if ( null === $param ) {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $ANESTA_STORAGE[ $var_name ] ) ? $ANESTA_STORAGE[ $var_name ]->$method() : '';
		} else {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $ANESTA_STORAGE[ $var_name ] ) ? $ANESTA_STORAGE[ $var_name ]->$method( $param ) : '';
		}
	}
}

if ( ! function_exists( 'anesta_storage_get_obj_property' ) ) {
	/**
	 ...
	 */
	function anesta_storage_get_obj_property( $var_name, $prop, $default = '' ) {
		global $ANESTA_STORAGE;
		return ! empty( $var_name ) && ! empty( $prop ) && isset( $ANESTA_STORAGE[ $var_name ]->$prop ) ? $ANESTA_STORAGE[ $var_name ]->$prop : $default;
	}
}
