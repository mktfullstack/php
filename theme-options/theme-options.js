...
jQuery( document ).ready( function() {
	...
	function anesta_options_start_check_dependencies() {
		jQuery( '.anesta_options .anesta_options_section' ).each(
			function () {
	...
	jQuery( document ).ready( anesta_options_start_check_dependencies );

	// Check external dependencies (for example, "Page template" in the page edit mode)
	jQuery( window ).on( 'load', anesta_options_start_check_dependencies );

	// Check dependencies on any field change
	jQuery( '.anesta_options .anesta_options_item_field [name^="anesta_options_field_"]' ).on(
		'change', function () {
	...
	function anesta_options_check_dependencies(cont) {
		...
		cont.find( '.anesta_options_item_field,.anesta_options_group[data-param]' ).each(
			function() {
