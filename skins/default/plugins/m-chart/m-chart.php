...
if ( ! function_exists( 'anesta_m_chart_tgmpa_required_plugins' ) ) {    
    function anesta_m_chart_tgmpa_required_plugins( $list = array() ) {
        ...
        if ( anesta_storage_isset( 'required_plugins', 'm-chart-highcharts-library-master' ) && anesta_storage_get_array( 'required_plugins', 'm-chart-highcharts-library-master', 'install' ) !== false ) {
            $path = anesta_get_plugin_source_path( 'plugins/m-chart-highcharts-library-master/m-chart-highcharts-library-master.zip' );
			if ( ! empty( $path ) || anesta_get_theme_setting( 'tgmpa_upload' ) ) {
				$list[] = array(
					'name'     => anesta_storage_get_array( 'required_plugins', 'm-chart-highcharts-library-master', 'title' ),
					'slug'     => 'm-chart-highcharts-library-master',
					'source'   => ! empty( $path ) ? $path : 'upload://m-chart-highcharts-library-master.zip',
					'version'  => '1.1',
					'required' => false,
				);
			}
