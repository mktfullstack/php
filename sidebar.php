...
if ( anesta_sidebar_present() ) {
	...
	if ( ! empty( $anesta_out ) ) {
		...
		<div class="sidebar widget_area
			...
			if ( 'float' == $anesta_sidebar_position_ss ) {
				echo ' sidebar_float';
			}
			$anesta_sidebar_scheme = anesta_get_theme_option( 'sidebar_scheme' );
			if ( ! empty( $anesta_sidebar_scheme ) && ! anesta_is_inherit( $anesta_sidebar_scheme ) ) {
