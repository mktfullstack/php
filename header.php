	...
	<div class="<?php echo esc_attr( apply_filters( 'anesta_filter_body_wrap_class', 'body_wrap' ) ); ?>" <?php do_action('anesta_action_body_wrap_attributes'); ?>>
		...
		<div class="<?php echo esc_attr( apply_filters( 'anesta_filter_page_wrap_class', 'page_wrap' ) ); ?>" <?php do_action('anesta_action_page_wrap_attributes'); ?>>
			...
			if ( ! $anesta_full_post_loading && ! $anesta_prev_post_loading ) {
				...
				?>
				<a class="anesta_skip_link skip_to_content_link" href="#content_skip_link_anchor" tabindex="1"><?php esc_html_e( "Skip to content", 'anesta' ); ?></a>
				<?php if ( anesta_sidebar_present() ) { ?>
				<a class="anesta_skip_link skip_to_sidebar_link" href="#sidebar_skip_link_anchor" tabindex="1"><?php esc_html_e( "Skip to sidebar", 'anesta' ); ?></a>
				<?php } ?>
				<a class="anesta_skip_link skip_to_footer_link" href="#footer_skip_link_anchor" tabindex="1"><?php esc_html_e( "Skip to footer", 'anesta' ); ?></a>
