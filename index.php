    ...
    <div class="banner-head">
        <div class="banner-head-padding banner-head-margin">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12"> <span class="heading-meta"><?php if(isset($pwe_redux_demo['blog_meta']) && $pwe_redux_demo['blog_meta'] != ''){?>
                        <?php echo htmlspecialchars_decode(esc_attr($pwe_redux_demo['blog_meta']));?>
                    <?php }else{?>
                        <?php echo esc_html__( 'read', 'pwe' );
                    }
                    ?></span>
                    <h2 class="pwe-heading animate-box" data-animate-effect="fadeInLeft"><?php if(isset($pwe_redux_demo['blog_title']) && $pwe_redux_demo['blog_title'] != ''){?>
                        <?php echo htmlspecialchars_decode(esc_attr($pwe_redux_demo['blog_title']));?>
                    <?php }else{?>
                        <?php echo esc_html__( 'Blog', 'pwe' );
                    }
                    ?></h2>
                </div>
            </div>
