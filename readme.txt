...
Please install and activate it before starting to use the theme Anesta.
...
Theme documentation is available on http://anesta.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Anesta is Fontello.
