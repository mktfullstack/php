...
if ( ! function_exists( 'anesta_wp_scripts' ) ) {
	...
	function anesta_wp_scripts() {
		...
		if ( anesta_is_singular( 'post' ) && anesta_get_theme_option( 'single_parallax' ) != 0 ) {
...
if ( ! function_exists( 'anesta_theme_fonts_links' ) ) {
	 ...
	 */
	function anesta_theme_fonts_links() {
		$links = array();
...
if ( ! function_exists( 'anesta_theme_fonts_for_editor' ) ) {
	 ...
	 *                ]
	 */
	function anesta_theme_fonts_for_editor() {
		$links = array_values( anesta_theme_fonts_links() );
...
$anesta_required_plugins = anesta_storage_get( 'required_plugins' );
