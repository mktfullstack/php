    ...
    <div class="banner-head">
        <div class="banner-head-padding banner-head-margin">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12"> 
                    <h2 class="pwe-heading animate-box" data-animate-effect="fadeInLeft"><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'pwe' ), get_the_date() );
                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'pwe' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'pwe' ) ) );
                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'pwe' ), get_the_date( _x( 'Y', 'yearly archives date format', 'pwe' ) ) );
                        else :
                            echo esc_html__( 'Archives', 'pwe' );
                        endif;
                        ?></h2>
                </div>
            </div>
