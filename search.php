    ...
    <div class="banner-head">
        <div class="banner-head-padding banner-head-margin">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="pwe-heading animate-box" data-animate-effect="fadeInLeft"><?php printf( esc_html__( 'Search Results for: %s', 'pwe' ), get_search_query() ); ?></h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                while (have_posts()): the_post();
                 ...
                 <?php endwhile; else :?>
                    <div class="search-custom"><h4><?php
                        ...
                        echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'pwe' ) ;?></h4>
